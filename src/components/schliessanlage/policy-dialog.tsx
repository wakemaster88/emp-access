    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        ...
        <div className="space-y-3">
          {!isNew && (
            <p className="rounded bg-muted/50 px-2 py-1.5 text-[11px] text-muted-foreground dark:bg-muted/50">
          ...
          <div className="space-y-1">
            <Label htmlFor="p-body" className="text-xs">
              Belehrung <span className="text-destructive">*</span>
            </Label>
            <textarea
              id="p-body"
              value={bodyText}
              ...
              rows={12}
              className="w-full rounded-md border border-border bg-white p-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring dark:border-border dark:bg-card"
            />
          </div>
