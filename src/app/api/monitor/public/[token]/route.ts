        ...
        try {
          ...
          const scans = await prisma.scan.findMany({
            ...
            include: {
              ...
              ticket: { select: { id: true, name: true, firstName: true, lastName: true, ticketTypeName: true, validityType: true, validityDurationMinutes: true, firstScanAt: true, profileImage: true, endDate: true, subscriptionId: true } },
            },
            orderBy: { id: "desc" },
